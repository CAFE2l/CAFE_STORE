...
const socialLinksList: { platform: 'discord' | 'telegram' | 'twitter' | 'linkedin' | 'youtube'; href: string; label: string }[] = [
...
function SocialIconButton({ platform, href, label }: { platform: 'discord' | 'telegram' | 'twitter' | 'linkedin' | 'youtube'; href: string; label: string }) {
  return (
    <a
      href={href}
      target="_blank"
          ...
          >
            ...
            <div className="mt-6 flex gap-[10px]">
              {socialLinksList.map((social, i) => (
                ...
                >
                  <SocialIconButton platform={social.platform} href={social.href} label={social.label} />
                </div>
              ))}
            </div>
          </div>

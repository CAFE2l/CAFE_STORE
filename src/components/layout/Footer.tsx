...
export function Footer() {
  const whatsappUrl = 'https://wa.me/5541996713782?text=Ol%C3%A1%2C%20tenho%20interesse%20nos%20produtos%20CAF%C3%89!';
        ...
        <div className="container-page grid gap-8 py-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-3 grid gap-2 text-sm text-text-muted">
              ...
              <Link href="/servicos" className="transition hover:text-cafe-orange-500">Serviços</Link>
          ...
          <div>
            ...
            <div className="mt-3 grid gap-2 text-sm text-text-muted">
              <Link href="/servicos" className="flex items-center gap-2 transition hover:text-cafe-orange-500">
                <HelpCircle className="h-3.5 w-3.5" />
                Atendimento
              </Link>
              <Link href="/servicos" className="transition hover:text-cafe-orange-500">Política de troca</Link>
              <Link href="/servicos" className="transition hover:text-cafe-orange-500">Frete e prazos</Link>
              <Link href="/servicos" className="transition hover:text-cafe-orange-500">FAQ</Link>
            </div>
        ...
        <div className="border-t border-border-subtle">
          <div className="container-page flex flex-col items-center justify-between gap-4 py-6 text-xs text-text-muted sm:flex-row">
            ...
            <div className="flex gap-4">
              <Link href="/servicos" className="transition hover:text-cafe-orange-500">Política de privacidade</Link>
              <Link href="/servicos" className="transition hover:text-cafe-orange-500">Termos de uso</Link>
            </div>
          </div>
        </div>
      </div>

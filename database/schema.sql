...
(3, 'Chaveiro Flame CAFÉ', 'chaveiro-flame-cafe', 'Chaveiro simbólico com identidade da CAFÉ STORE para quem quer apoiar o projeto. Campanhas físicas serão comunicadas separadamente.', 'Chaveiro simbólico da marca CAFÉ.', 19.90, NULL, 'assets/images/produtos/chaveiro/design.png', 'assets/images/produtos/chaveiro/design.png', 120, 'chaveiro', 1, 'active'),
(4, 'Caneca CAFÉ STORE', 'caneca-cafe-store', 'Caneca simbólica da CAFÉ STORE para apoiadores da marca. Este item representa apoio/donate enquanto a produção oficial não estiver ativa.', 'Caneca simbólica para apoiar a marca.', 44.90, NULL, 'assets/images/produtos/caneca/preta/design.png', 'assets/images/produtos/caneca/preta/design.png', 60, 'caneca', 1, 'active'),
